...
router.get("/crawl_tool_story", async (req, res) => {
  return res.send("craw =ddfffcvbfgd successsss");
});
// router.post("/crawl_tool_story", async (req, res) => {
//   fs.rmSync(path.join(root_path+'/public/download/', 'table.txt'), { recursive: true, force: true });
//   fs.rmSync(path.join(root_path+'/public/download/', 'time.txt'), { recursive: true, force: true });
